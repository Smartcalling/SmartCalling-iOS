...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
    Using the SmartCalling SDK let's you add a contact to the iOS AddressBook so users of your app can know when they receive a call from a valid call center number
                       DESC
